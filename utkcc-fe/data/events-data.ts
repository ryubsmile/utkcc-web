...
export const eventData: EventTileProps[] = [
  {
    info: {
      ...
      explanation:
        '대학 공부는 처음이라 버겁게 느껴진다면, UTKCC와 함께 공부해요. 코스를 미리 들어본 선배들에게만 들을 수 있는 팁과 문제풀이 방식을 각 과목 튜토리얼을 통해 배워갈 수 있습니다.',
    },
  },
  {
    info: {
      ...
      explanation:
        '대학생활 이후의 미래, UTKCC와 함께라면 걱정하지 마세요. 현직자들의 뼈 있는 조언과 더 나아가 인생의 로드맵까지 생각해 볼 수 있는 기회가 될 거에요. UTKCC가 프로페셔널한 이유를 직접 오셔서 확인해보세요.',
    },
  },
  {
    info: {
